...
static int16_t ECOCALLMETHOD CEcoLab1_cocktail_sort_int64(/* in */ IEcoLab1Ptr_t me, /* in */ int64_t* array, /* in */ uint32_t n) {
    int swapped = 1;
    uint32_t start = 0;
    uint32_t end = n - 1;
    uint32_t i;
...
static int32_t ECOCALLMETHOD CEcoLab1_CalcAdd(/* in */ IEcoLab1Ptr_t me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoLab1* pCMe = (CEcoLab1*)me;
    ...
    /* Делегируем вызов внутреннему калькулятору */
    return pCMe->m_pIX->pVTbl->Addition(pCMe->m_pIX, a, b);
}

static int16_t ECOCALLMETHOD CEcoLab1_CalcSubtract(/* in */ IEcoLab1Ptr_t me, /* in */ int16_t a, /* in */ int16_t b) {
    CEcoLab1* pCMe = (CEcoLab1*)me;
...
int16_t ECOCALLMETHOD initCEcoLab1(/*in*/ IEcoLab1Ptr_t me, /* in */ struct IEcoUnknown *pIUnkSystem) {
	...
	/* Получение компонента калькулятора */
...
IEcoLab1VTbl g_x277FC00C35624096AFCFC125B94EEC90VTbl = {
    ...
    CEcoLab1_Release,
    CEcoLab1_MyFunction,
	CEcoLab1_cocktail_sort_int64, // Добавляем нашу новую функцию
	CEcoLab1_CalcAdd,
    CEcoLab1_CalcSubtract
};
